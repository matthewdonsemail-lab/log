...
| Task | Command |
|---|---|
| Backend tests (114) | `pnpm test:backend` |
| Web tests (179) | `pnpm --filter web test` |
| Python tests (85) | `python -m pytest clients/tests` (the browser tests start real Chrome and take a few minutes) |
