...
export const API_ROUTES: ApiRouteDef[] = [
  ...
  { method: 'PATCH', path: '/listings/:listingId', needs: { account: true } },
  { method: 'PATCH', path: '/listings/:listingId/status', needs: { account: true } },
  { method: 'GET', path: '/listings/:listingId/status', needs: { account: true } },
