...
export const apiKeysListRef = makeFunctionReference<'query', Record<string, never>, unknown>('apiKeys:listKeys')
export const apiKeysCreateRef = makeFunctionReference<'mutation', { label: string; scopes?: string[] }, unknown>('apiKeys:createKey')
export const apiKeysRevokeRef = makeFunctionReference<'mutation', { id: string }, unknown>('apiKeys:revokeKey')
export const webhooksListRef = makeFunctionReference<'query', Record<string, never>, unknown>('webhooks:list')
export const webhooksDeliveriesRef = makeFunctionReference<'query', { id: string }, unknown>('webhooks:deliveries')
export const webhooksCreateRef = makeFunctionReference<'mutation', { url: string; minScore?: number; platforms?: string[] }, unknown>('webhooks:create')
export const webhooksUpdateRef = makeFunctionReference<'mutation', { id: string; active?: boolean; minScore?: number }, unknown>('webhooks:update')
export const webhooksRemoveRef = makeFunctionReference<'mutation', { id: string }, unknown>('webhooks:remove')
export const webhooksTestRef = makeFunctionReference<'action', { id: string }, unknown>('webhooks:test')
